...
// Run model...
*===============================================================================
sae model lmm `lhs' `_Xx' if `touse23'==1 [aw=`wvar'], area(`area') ///
varest(`varest') zvar(`zvar') yhat(`yhat') yhat2(`yhat2') ebest uniq(`uniqid') seed(`seed')
...
*===============================================================================
	...
	forval z=1/`bsrep'{
		...
		qui:sae model lmm _NeWy `_Xx' if `touse23'==1 [aw=`wvar'], area(`area') ///
		varest(`varest') zvar(`zvar') yhat(`yhat') yhat2(`yhat2') ebest seed(`seed') uniq(`uniqid') 
